...
--- Instruction ---
Rephrase the new input to match the same style, voice, and structure as the example(s). Do not copy the text. Make it sound like the same author wrote it, with professional and persuasive legal tone.
"""
