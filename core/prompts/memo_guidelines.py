...
All deposition and complaint excerpts must be quoted exactly and embedded naturally within the narrative. Each Facts/Liability and Harms section must include at least three unique direct quotes. Quotes must:
...
- Support the factual or legal point being made.
"""

SECTION_SPECIFIC_NOTE = """
Each section must meet the following:
- **Introduction:** Concisely frame the case value and posture. Do not repeat the facts.
- **Demand:** Two sentences summarizing settlement position, objective tone.
- **Facts/Liability:** Provide detailed narrative establishing duty, breach, and causation. Embed at least three quotes.
- **Causation/Injuries:** Connect facts to injuries and treatment. Avoid redundancy.
- **Harms:** Describe functional, professional, and emotional impact. Embed at least three quotes.
- **Future Medical:** Outline anticipated care and costs. Reference supporting testimony.
- **Conclusion:** End firmly with litigation readiness language. No overexplaining.
"""
